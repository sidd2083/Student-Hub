  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-0 overflow-hidden">
        ...
        <main
          ...
          style={{
            ...
            // Study-room pages: global nav (4rem) stays visible — room tab bar floats above it.
            // All other pages: pad for the global bottom nav (5rem with safe-area).
      ...
      {/* ── Mobile Bottom Navigation — always visible.
           On study-room pages the room's own tab bar floats above this nav.
           On all other pages this is the primary navigation.                      */}
      <nav
