        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 text-center mb-5">
          ...
          <div className="flex gap-2 justify-center mb-8">
            {([25, 50] as const).map((m) => (
              <button
                ...
                className={`px-5 py-2 rounded-full text-sm font-medium transition-all ${
                  preset === m ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"
                }`}
              >
                {m} min
              </button>
            ...
            <button
              ...
              className={`px-5 py-2 rounded-full text-sm font-medium transition-all ${
                preset === "custom" ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"
              }`}
            >
              Custom
            </button>
          ...
          {preset === "custom" && (
            <div className="flex items-center gap-2 justify-center mb-7">
              <input
                ...
                className="w-20 text-center border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="min"
              />
