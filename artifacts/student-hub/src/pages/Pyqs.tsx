...
import {
  ...
  Bookmark, ZoomIn, ZoomOut, Maximize, Minimize, Calculator, CalendarCheck,
} from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="p-4 sm:p-6 lg:p-8 max-w-full overflow-x-hidden">
        ...
        {/* Tool recommendations — shown only to guests (SEO + discovery); logged-in users already know the tools */}
        {!isLoggedIn && (
